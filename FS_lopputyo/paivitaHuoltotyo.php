...
if(isset($_POST['talleta'])){
    ...
    $komento = "UPDATE huoltotyo SET asuntoid = :asuntoid, asoyid = :asoyid, ilmoittaja = :ilmoittaja, kuvaus = :kuvaus, statusid = :statusid, tyontekijaid = :tyontekijaid, kommentit = :kommentit WHERE huoltoid = :huoltoid";
    ...
    $lisaa->bindValue(':huoltoid', $huoltoid, PDO::PARAM_INT);
    $lisaa->execute();
}
